...
public class ControllerAgenda {
	...
	private final Map<Integer, LogsModificacions> m_logsModifLinies;
	...
	public void addLogsPublicacions() {
		for (Entry<String, Publicacio> publicacio : m_ordres.entrySet()) {
			Publicacio l_publicacio = publicacio.getValue();
			for (LogsModificacions l_log : m_logsDao.getEntrades(publicacio.getKey())) {
