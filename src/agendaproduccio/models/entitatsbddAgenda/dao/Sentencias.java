...
public class Sentencias {
	...
	public static String BuildSelectLogs(String l_sentencia) {
		StringBuilder l_builder = new StringBuilder();
		String l_condicions = "  WHERE (NomCamp='Enquadernat' or NomCamp='Mida Pàgina' or NomCamp like "
				+ "'Paper %' or NomCamp like 'Ampla%' or NomCamp='Distribució Tiratges' or "
				+ "NomCamp='Planes Publicació')";
