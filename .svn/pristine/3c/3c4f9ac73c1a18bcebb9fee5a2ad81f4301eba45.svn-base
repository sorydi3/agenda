...
public class OrdreLiniaRutaDAO {
	...
	private OrdreLiniaRutaDAO() {
		...
		*/
		...
		m_camps[36][0] = "o.DataPrevistaInterior";
		m_camps[37][0] = "o.DataPrevistaCobertes";
		m_camps[38][0] = "o.DataJobTicketFet";
	...
	public OrderLiniaRutaPNavison Fill(Object[] p_fila) {
		...
		l_res.m_DataPrevistaInterior_o = p_fila[36] == null ? null
				: m_dh.MySQLFormatToCalendarFormat((String) p_fila[36]);
		l_res.m_DataPrevistaCobertes_o = p_fila[37] == null ? null
				: m_dh.MySQLFormatToCalendarFormat((String) p_fila[37]);
		l_res.m_DataJobTicketFet_o = p_fila[38] == null ? null : m_dh.MySQLFormatToCalendarFormat((String) p_fila[38]);
		l_res.setTipus();
		return l_res;
	}
	...
	private String getSubstringData(String data_hora) {
		return data_hora.substring(0, data_hora.indexOf(' '));
	}
